    ...
    >
      <label className="h-[43px] rounded-full relative bg-[#202327] w-full group border border-transparent focus-within:bg-black focus-within:border-[#1d9bf0]">
        ...
        <input
          placeholder="Ara"
          type="text"
          className="w-full h-full placeholder-[#71767a] bg-transparent rounded-full outline-none pl-[56px] text-[15px] "
          value={query}
        ...
        {focus && (
          <div className="absolute top-full -left-px w-[350px] translate-y-1 bg-black shadow-box px-4 max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
